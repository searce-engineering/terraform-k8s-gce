...
variable cluster_autoscalar_min {
  description = "Cluster autoscalar min"
}

variable cluster_autoscalar_max {
  description = "Cluster autoscalar max"
}

variable kube_env {
  description = "The kube-env metadata for instance template for CA scale up from 0 to x"
  type        = "list"
  default     = []
}
